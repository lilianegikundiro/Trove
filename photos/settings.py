...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PARSER_CLASSES': [
        'rest_framework.parsers.JSONParser', 'rest_framework.permissions.IsAuthenticated',
    ],
...
cloudinary.config( 
  cloud_name = "dbgooph5c", 
  api_key = "641157311817456", 
  api_secret = "3NwXTTrOv9QIc-vEJ4-HEBRDaBc" 
)
